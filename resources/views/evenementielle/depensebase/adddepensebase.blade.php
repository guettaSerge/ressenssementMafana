...
<div>
    <div id="listHeader">
        <div>
            <h2 class="text-center" style="font-size: 30px;">Ajout des depensebase</h2>
            <section class="contact-clean">
                <form class="text-center" method="post" action="/depensebase">
                    @csrf
                    ...
                    <input class="form-control" type="number" name="tarifstandart">
                    ...
                    <input class="form-control" type="number" name="tarifpremium">
