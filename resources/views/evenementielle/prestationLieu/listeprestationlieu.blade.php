...
<div>
    <div id="listHeader">
        <div>
            <h2 class="text-center" style="font-size: 30px;">Liste des prestaions d'lieu</h2>
        </div>
        <div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center" style="background: #ffffff;">
                        <a class="btn btn-success" href="/prestationlieu/edit?id={{$art->id}}">&nbsp;modifier</a>
                        </td>
                </tr>
            @endforeach
            </tbody>
    ...
    <div class="text-center">
        <nav class="text-center" style="margin: 0 auto">
            {{$prestationlieu->onEachSide(2)->links()}}
        </nav>
    </div>
