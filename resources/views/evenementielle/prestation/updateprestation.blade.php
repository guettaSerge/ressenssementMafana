...
<div>
    <div id="listHeader">
        <div>
            <h2 class="text-center" style="font-size: 30px;">update prestation</h2>
            <section class="contact-clean">
                <form class="text-center" method="post" action="/prestation/update">
                    @csrf
                    ...
                    <input class="form-control" type="datetime-local" name="debut" value="{{$prestation->debut}}">
                    ...
                    <input class="form-control" type="datetime-local" name="fin" value="{{$prestation->fin}}">
