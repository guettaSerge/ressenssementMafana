...
<div>
    <div id="listHeader">
        <div>
            <h2 class="text-center" style="font-size: 30px;">Modifier prestation d'artiste </h2>
            <section class="contact-clean">
                <form class="text-center" method="post" action="/prestationartiste/update">
                    @csrf
                    <input type="hidden" name="id" value="{{$prestationartiste->id}}">
                    ...
                    <input class="form-control" type="number" name="duree" value="{{$prestationartiste->tarif}}">
