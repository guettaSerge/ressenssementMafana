...
<div>
    <div id="listHeader">
        <div>
            <h2 class="text-center" style="font-size: 30px;">Modifier un domicile</h2>
            <section class="contact-clean">
                <form class="text-center" method="post" action="/domicile/update">
                    @csrf
                    <input class="form-control" type="hidden" name="id" value="{{$domicile->id}}">
                    <label class="form-label">nom</label>
                    <input class="form-control" type="text" name="nom" value="{{$domicile->nom}}">
