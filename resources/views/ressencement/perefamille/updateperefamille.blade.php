...
<div>
    <div id="listHeader">
        <div>
            <h2 class="text-center" style="font-size: 30px;">Modifier pere de famille </h2>
            <section class="contact-clean">
                <form class="text-center" method="post" action="/perefamille/update">
                    @csrf
                    <label class="form-label">personne</label>
                    <input class="form-control" type="hidden" name="id" value="{{$perefamille->id}}">
                    ...
                    <input class="form-control" type="date" name="dateadmission" value="{{$perefamille->dateadmission}}">
